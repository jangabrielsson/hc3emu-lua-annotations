...
---Logs to the console with DEBUG prefix.
---
...
---Logs to the consolue with WARNING prefix.
---
---@param tag string Name of tag, , usually __TAG for QuickApps and _sceneId for Scenes.
---@param ... any Arguments to be printed.
---@return nil
...
---Logs to the consolue with TRACE prefix.
---
---@param tag string Name of tag, , usually __TAG for QuickApps and _sceneId for Scenes.
---@param ... any Arguments to be printed.
---@return nil
...
---Logs to the consolue with ERROR prefix.
---
---@param tag string Name of tag, , usually __TAG for QuickApps and _sceneId for Scenes.
---@param ... any Arguments to be printed.
---@return nil
